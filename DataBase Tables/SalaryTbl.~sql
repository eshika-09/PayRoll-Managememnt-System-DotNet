...
--delete from salarytbl_1 where empid=1

insert into salarytbl_1(empid,full_name,designation,dept,basic_pay)values(4,'Ayush Wunnava','Associate SDE', 'IT & CNS', 10000);
...
values(1,'Eshika Goyal','SDE 1','IT & CNS','January',2023,70000,2258.064,14000,7000,1400,700,2100,2800,2,23100,13683.87,79416.13);
