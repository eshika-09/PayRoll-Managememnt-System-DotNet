...
select t.dept_code from master_dept t where dept_name='Accounts';
...
--drop table master_dept
--drop sequence dept_seq


insert into master_dept (dept_code, dept_name) values('GP', 'General Procurement');
