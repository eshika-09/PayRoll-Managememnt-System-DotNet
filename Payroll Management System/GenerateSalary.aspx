...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox14" runat="server" placeholder="Employee has taken in that month" TextMode="Number"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <br />
    <br />
    <div id="HideDiv" runat="server" visible="false" class="container-fluid">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Provident Fund" TextMode="Number"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox13" runat="server" placeholder="FA" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-4 mx-auto">
                        ...
                        <div class="row">
                            <div class="col-4 mx-auto">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox15" runat="server" placeholder="Total" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-4 mx-auto">
                                <label>Deduction</label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox16" runat="server" placeholder="Total" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4 mx-auto">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox17" runat="server" placeholder="GRAND TOTAL" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
