<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Payroll_Management_System.SignUp" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="ddlDept" runat="server" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Login Credential"></asp:Label>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="validator" runat="server" ControlToValidate="TextBox10" ErrorMessage="Password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, and one numeric digit, and a special character." ForeColor="Red" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z])[^\s]{8,}$"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
